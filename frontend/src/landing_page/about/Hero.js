    ...
    return ( 
        <div className="container">
            <div className="row p-5">
                <h2 className="fs-3 text-center mt-5 mb-5">We pioneered the discound broking model in India. <br/> Now, we are breaking ground with our technology.</h2>
            </div>
             <div className="row p-5  border-top">
             <div className="col-6 p-5 text-muted fs-6 "style={{lineHeight:"1.8"}}>
